...
class GasModal {
    ...
    createModalWrapper() {
        const existingWrapper = document.getElementById('cometh-gas-modal-wrapper');
        if (existingWrapper) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve) => {
                ...
                root.render(react_1.default.createElement("div", { style: {
                    ...
                    react_1.default.createElement(ui_1.GasModal, { onDeny: deny, onAccept: accept, balance: +balance, txGasFees: +txGasFees, isOpen: true, withBackdrop: true })));
            });
        });
    }
}
